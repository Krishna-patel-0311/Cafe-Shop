<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="UserHome.aspx.cs" Inherits="cafe.UserHome" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-5">
        <div class="jumbotron" style="background-color: #272b2f;">
            <div class="container">
                ...
                <p><a class="btn btn-success btn-lg" href="UserAboutus.aspx" role="button">About Us &raquo;</a></p>
            </div>
        </div>
    </div>
    ...
    <div class="mb-5">
        <div class="text-bg-darkme-md-4 text-center">
            ...
            <div class="zoom shadow-sm mx-auto" style="width: 348px; height: 417px;">
