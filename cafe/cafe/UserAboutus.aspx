<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.Master" AutoEventWireup="true" CodeBehind="UserAboutus.aspx.cs" Inherits="cafe.UserAboutus" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="jumbotron" style="background-color: #272b2f">
        <div class="container">
            ...
            <br />
            <p style="text-align: center"><a class="btn btn-success btn-lg" href="UserHome.aspx" role="button">HOME &raquo;</a></p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class=" mt-4 mb-4">
            ...
            <asp:Panel ID="Panel2" runat="server">
                ...
                <p><a class="btn btn-primary btn-lg" href="Usercontactus.aspx" role="button"> Futher Contact &raquo;</a></p>
            </asp:Panel>
            <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" TargetControlID="Panel2" CollapseControlID="Panel1" ExpandControlID="Panel1" CollapsedText="Contact Us" ExpandedText="^" TextLabelID="Label1" />
        </div>
    </div>
