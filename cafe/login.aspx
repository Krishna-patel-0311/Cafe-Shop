                                ...
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <div class="form-outline mt-4">
                                            ...
                                            <asp:TextBox ID="tb_username"  placeholder="@username" runat="server" CssClass="form-control">Admin</asp:TextBox>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <asp:TextBox ID="tb_password" CssClass="form-control" placeholder="password" runat="server"  TextMode="Password" >Pass</asp:TextBox>
